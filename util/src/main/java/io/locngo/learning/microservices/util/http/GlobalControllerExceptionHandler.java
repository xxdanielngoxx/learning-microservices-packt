package io.locngo.learning.microservices.util.http;
...
public class GlobalControllerExceptionHandler {
    ...
    public @ResponseBody HttpErrorInfo handleInvalidException(ServerHttpRequest request, Exception exception) {
    ...
    private HttpErrorInfo createHttpErrorInfo(HttpStatus httpStatus, ServerHttpRequest request, Exception exception) {
        ...
        LOGGER.debug("Returning HTTP status: {} for path, message: {}", httpStatus, message);

...
import io.locngo.learning.microservices.recommendation.service.services.RecommendationMapper;
...
public class MapperTests {
    ...
    public void mapperListTests() {
        ...
        Recommendation api = new Recommendation(1, 2, "a", 4, "C", "ard");
        ...
        assertEquals(entityList.size(), api2List.size());

        Recommendation api2 = api2List.get(0);

        assertEquals(api.getProductId(), api2.getProductId());
        assertEquals(api.getRecommendationId(), api.getRecommendationId());
        assertEquals(api.getAuthor(), api2.getAuthor());
        assertEquals(api.getRate(), api2.getRate());
        assertEquals(api.getContent(), api2.getContent());
        assertNull(api2.getServiceAddress());
